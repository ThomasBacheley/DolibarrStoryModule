...
/**
 *  \file       core/modules/story/doc/pdf_standard.modules.php
 *  \ingroup    story
...
/**
 *	Class to manage PDF template standard_story
 */
class pdf_standard_story extends ModelePDFStory
{
	/**
	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
		...
		/*
		if (!empty($conf->global->MAIN_GENERATE_STORY_WITH_PICTURE))
		{
		...
		*/
		...
		if ($conf->story->dir_output.'/story') {
			$object->fetch_thirdparty();

			// Definition of $dir and $file
			if ($object->specimen) {
				$dir = $conf->story->dir_output.'/story';
				$file = $dir."/SPECIMEN.pdf";
			} else {
				$objectref = dol_sanitizeFileName($object->ref);
				$dir = $conf->story->dir_output.'/story/'.$objectref;
