...
/**
 * \file    test/phpunit/StoryFunctionalTest.php
 * \ingroup story
 ...
 * @package Teststory
 */
class StoryFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/story/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('story/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/story/admin/about.php');
		$this->authenticate();
		return $this->assertContains('story/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('storywidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modStory_StoryTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modStory_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
